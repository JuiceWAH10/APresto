...
function ClientEditReward(props) {
    const [rewName, setTextRN] = React.useState('');
    const [rewPrice, setTextRP] = React.useState('');
    const [rewStock, setTextRS] = React.useState('');
    return (
        <ImageBackground
        ...
        source={require('../assets/Store-Blur.png')}>
            ...
            <View style={styles.LogoContainer}>   
                    <Text style={{color: '#fff', fontSize: 22,}}>Edit Reward</Text>
            </View>
            <View style={styles.AddProdBG}>
                ...
                <Text style={{color:'#fd4140',fontSize: 16,}}>Reward Name*</Text>

                <TextInput
                    style={styles.textInputs}
                    placeholder="Enter Reward Name"
                    value={rewName}
                    onChangeText={text => setTextRN(text)}
                />
                ...
                <View style={styles.toCenter}>
                    <Text style={{color:'#fd4140',fontSize: 16,}}>Reward Category</Text>
                </View>   
                ...
                <TextInput
                    ...
                    value={rewPrice}
                    onChangeText={text => setTextRP(text)}
                />
                </View>    
                ...
                <TextInput
                    ...
                    value={rewStock}
                    onChangeText={text => setTextRS(text)}
                />
                </View>        
...
export default ClientEditReward;